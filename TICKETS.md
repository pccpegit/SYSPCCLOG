...
| SYSPCC-017 | fix | `fix/SYSPCC-017-secretos-a-env` | Seguridad: sacar del repo el GUID de ONEDRIVE_CLIENT_ID y la DEMO_PASSWORD hardcodeada (los 3 seeds) → todo por env + tests | _pendiente_ | En progreso |
