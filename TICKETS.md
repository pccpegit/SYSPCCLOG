...
| SYSPCC-008 | fix | `fix/SYSPCC-008-import-pasajes-integridad` | Import pasajes (🔴): savepoints por fila (no envenena tx) + idempotencia (update_or_create sobre codigo_id_legado unique) + tests | _pendiente_ | En progreso |
