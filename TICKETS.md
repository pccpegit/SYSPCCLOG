...
| SYSPCC-012 | fix | `fix/SYSPCC-012-error-handling-resiliencia` | Error handling 🟡: except concretos + logging, retries Celery, OneDrive async, fugas de excepción, última barrera en execute_action + tests | _pendiente_ | En progreso |
