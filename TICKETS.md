...
| SYSPCC-011 | fix | `fix/SYSPCC-011-seguridad-acceso-media` | Seguridad 🟡: scope de lecturas (RQ/cotiz/OC), update_items con rol, OneDrive org-scope, guarda de seeds en prod, CanPerformWorkflowAction + tests | _pendiente_ | En progreso |
