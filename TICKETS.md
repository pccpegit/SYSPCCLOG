...
| SYSPCC-019 | fix | `fix/SYSPCC-019-oficina-central-flujo` | Nuevo RQ: frente OFICINA CENTRAL autoselecciona servicio/proyecto "Oficina Central" y fuerza flujo ADMINISTRATIVE (otros frentes → OPERATIONS); hoy el servicio queda bloqueado en "—" para usuarios sin departamento | _pendiente_ | En progreso |
