...
| SYSPCC-016 | feature | `feature/SYSPCC-016-onedrive-seguridad` | OneDrive (follow-up): cifrado de tokens en reposo (Fernet + fallback legacy) + scope/tenant configurable por settings + tests | _pendiente_ | En progreso |
