...
| SYSPCC-018 | feature | `feature/SYSPCC-018-modulo-administracion` | Módulo de administración (solo superadmin) bajo /admin: gestión de usuarios (CRUD, roles, activar/desactivar, reset de contraseña con cambio forzado) y de proyectos (CRUD, activar/desactivar) | _pendiente_ | En progreso |
