...
| SYSPCC-014 | chore | `chore/SYSPCC-014-tickets-status` | Corrige el estado de SYSPCC-013 en el registro (quedó "En progreso" sin ticket posterior que lo actualizara) | _pendiente_ | En progreso |
