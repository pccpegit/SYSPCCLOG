...
| SYSPCC-021 | chore | `chore/SYSPCC-021-demo-supabase-vercel` | Demo en capa gratuita: settings demo (Render free), render.yaml, vercel.json con proxy same-origin, guía de despliegue Supabase + Render + Vercel | — | En progreso |
