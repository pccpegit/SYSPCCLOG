...
| SYSPCC-015 | feature | `feature/SYSPCC-015-csrf-enforcement` | CSRF enforcement (follow-up): backend enforce_csrf en CookieJWTAuth + endpoint bootstrap; frontend interceptor X-CSRFToken + bootstrap; 8 tests back + 19 front | _pendiente_ | En progreso |
