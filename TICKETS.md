...
| SYSPCC-009 | fix | `fix/SYSPCC-009-error-handling-notificaciones` | Error handling (🔴): SLACalculator sin except silencioso + idempotencia de notificaciones (dedup_key) + fix bug task recordatorios + tests | _pendiente_ | En progreso |
