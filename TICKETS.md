...
| SYSPCC-019 | fix | `fix/SYSPCC-019-oficina-central-flujo` | Nuevo RQ: frente OFICINA CENTRAL autoselecciona servicio/proyecto "Oficina Central" y fuerza flujo ADMINISTRATIVE (otros frentes → OPERATIONS); hoy el servicio queda bloqueado en "—" para usuarios sin departamento | [#25](https://github.com/pccpegit/SYSPCCLOG/pull/25) | Mergeado |
| SYSPCC-020 | feature | `feature/SYSPCC-020-tema-oscuro` | Tema claro/oscuro en el frontend: toggle en el header de los 3 shells, preferencia persistente, y modo automático según hora del día configurable en Configuración | — | En progreso |
