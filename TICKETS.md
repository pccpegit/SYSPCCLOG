...
| SYSPCC-018 | feature | `feature/SYSPCC-018-modulo-administracion` | Módulo de administración (solo superadmin) bajo /admin: gestión de usuarios (CRUD, roles, activar/desactivar, reset de contraseña con cambio forzado) y de proyectos (CRUD, activar/desactivar) | [#24](https://github.com/pccpegit/SYSPCCLOG/pull/24) | En progreso |
